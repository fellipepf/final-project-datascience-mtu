...
class PreProcessing:
    ...
    def df_structure_category(self, df_data_set):
        ...
        df_data_set.loc[(df_data_set.index.hour >= 0) & (df_data_set.index.hour < 7),'category'] = 0

        #afternoon
        df_data_set.loc[(df_data_set.index.hour >= 7) & (df_data_set.index.hour < 19), 'category'] = 1

        #night
        df_data_set.loc[(df_data_set.index.hour >= 19) & (df_data_set.index.hour < 24), 'category'] = 2
